...
RSpec.describe MdIntegrations::Resources::Patients, :mdi do
  ...
  describe '#find' do
    it 'GETs /partner/patients/:id' do
      stub = stub_mdi(:get, "/partner/patients/#{patient_id}",
                      response_body: { id: patient_id })
  ...
  describe '#search' do
    it 'POSTs to /partner/patients/search with filters' do
      filters = { email: 'j@d.co' }
      stub = stub_mdi(:post, '/partner/patients/search',
  ...
  describe 'DoseSpot' do
    it 'fetches formulary coverage' do
      stub = stub_mdi(:get, "/partner/patients/#{patient_id}/dosespot/formulary",
